...
def compute_match_results(df: pd.DataFrame, model_name: str) -> list:
    ...
    for _, row in df.iterrows():
        ...
        ap = row["ap"]
        score = ap
        match_results.append([1.0, image_name, model_name, 1 - score, score, ap])
...
def main():
    ...
    parser.add_argument('--save_path', default="./data/detection/COCO/",type=str, help='path to save processed data')
    ...
    compute_ratings(match_result_folder, rating_result_folder, dataset_name="COCO", metric_name="AP@[.50:.95]", left_margin=800)
