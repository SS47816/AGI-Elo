...
def compute_match_results(df: pd.DataFrame, model_name: str) -> list:
    ...
    for _, row in df.iterrows():
        ...
        pdm_score = row['score']
        score = pdm_score
        match_results.append([1.0, scenario_id, model_name, 1 - score, score, pdm_score])
...
def main():
    ...
    compute_ratings(match_result_folder, rating_result_folder, dataset_name="NAVSIM", metric_name="PDM Score", left_margin=200)
